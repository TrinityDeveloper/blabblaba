...
public:
	...
	bool OnGossipHello(Player* player, Creature* creature)
	{
		...
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t What's this?", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+3);
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "|TInterface/ICONS/Thrown_1H_Harpoon_D_01Blue:30|t Spawn Transmogrification NPC", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2);
